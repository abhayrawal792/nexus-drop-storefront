...
describe("admin analytics aggregation", () => {
  it("calculates six-month order conversion and wishlist saves from real timestamps", () => {
    const result = buildAdminAnalytics(
      ...
      [{ created_at: "2026-08-04T00:00:00Z", products: { id: "p1", name: "Cuban Chain", price: 999, images: ["chain.jpg"] } }, { created_at: "2026-08-05T00:00:00Z", products: { id: "p1", name: "Cuban Chain", price: 999, images: ["chain.jpg"] } }],
    ...
    expect(result.topSavedProducts).toEqual([{ id: "p1", name: "Cuban Chain", price: 999, imageUrl: "chain.jpg", saves: 2 }]);
